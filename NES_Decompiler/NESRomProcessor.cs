...
public static class NESRomProcessor
{
    /// <summary>
    ...
    public static void Process(string input_file, string output_file)
    {
        ...
        writer.WriteLine(";The size of the {0} CHR ROM is {1}KB", rom_name, (byteArray.Length - (PRGSize + NESheader)) >> 10);
        writer.WriteLine();

        var nes = new NESDisassembler();
        ...
        {
            pc += nes.Disassemble(writer, byteArray, pc);
        }
    }
}
